...
public class AmazonS3ClientFactoryTest {
	...
	public void neverTrustTheDefaults() {
		...
		ExposingAmazonS3Client client = (ExposingAmazonS3Client) clientFactory.getAmazonS3(S3UnitTest.S3_GLOBAL_URI, props);
	...
	public void halfTheCredentials() {
		...
		clientFactory.getAmazonS3(S3UnitTest.S3_GLOBAL_URI, props);
	}
