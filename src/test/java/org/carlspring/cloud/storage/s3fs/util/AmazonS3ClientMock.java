...
public class AmazonS3ClientMock
        extends AbstractAmazonS3
{
    ...
    public ObjectListing listNextBatchOfObjects(ObjectListing previousObjectListing)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (continueElement)
            {
                ...
                if (previousObjectListing.getPrefix() != null && elem.getS3Object().getKey().startsWith(
            ...
            throws AmazonClientException
    {
        ...
        try
        {
            for (Path path : Files.newDirectoryStream(base))
            {
                ...
                bucket.setCreationDate(new Date(Files.readAttributes(path, BasicFileAttributes.class)
                                                     .creationTime()
                                                     .toMillis()));
    ...
    private S3Element parse(Path elem, Path bucket)
            throws IOException
    {
    ...
    public MockBucket bucket(String bucketName)
            throws IOException
    {
    ...
    public void addFile(Path bucket, String fileName)
            throws IOException
    {
    ...
    public void addFile(Path bucket, String fileName, byte[] content)
            throws IOException
    {
    ...
    public void addDirectory(Path bucket, String directoryName)
            throws IOException
    {
